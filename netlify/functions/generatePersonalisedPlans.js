...
- Pentru fiecare task, include: titlu, descriere scurtă care sa contina si metoda  de studiu sugerata in functie de ce tip de invatare i se potrivete elevului, durată (în minute ), resurse web și cărți, sau "nu e nevoie" daca nu e cazul ;
